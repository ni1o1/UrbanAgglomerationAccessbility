...
export default function Panelpage() {
  ...
  >
    ...
    >
      <SubMenu key="sub1" icon={<span className="iconfont icon-selectarea" />} title="社区可达性">
        <Menu.Item key="hourlytraj" icon={<span className="iconfont icon-selectarea" />}>社区可达性</Menu.Item>
      </SubMenu>
    </Menu>
